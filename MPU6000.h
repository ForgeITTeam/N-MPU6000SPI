...
class MPU6000 {
    ...
    private:
        ...
        boolean writeDMPMemory(int ChipSelPin);
        boolean verifyDMPMemory(int ChipSelPin);
        boolean writeDMPConfig(int ChipSelPin);
        boolean verifyDMPConfig(int ChipSelPin);
        unsigned int writeDMPUpdates(unsigned int pos, byte update_number, int ChipSelPin);
        unsigned int verifyDMPUpdates(unsigned int pos_verify, byte update_number, int ChipSelPin);
};
